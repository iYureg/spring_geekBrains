...
2. Использовать библиотеку Lombok:
...
3. Использовать configuration-processor для работы с настройками приложения:
   ...
   [sem2hw](https://github.com/iYureg/spring_geekBrains/blob/9cab0adaeea184e9a1a10764bb9ff6d8c7f61bcd/SpringGeekBrains/Webinar_2_spring_base_crud/homework/src/main/java/ru/gb/homeworkSpringCRUD)